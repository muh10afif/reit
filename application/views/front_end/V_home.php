    ...
    <body>
        ...
        <div id="main">
            ...
            <header class="main-header">
                ...
                <img src="<?= base_url() ?>assets_frontend/home/images/logo.png" style="margin-top:30px;"  alt="">
                </a>
                <!-- nav-button-wrap-->
                ...
                <a class=" color-bg" href="<?= base_url('frontend/Signin') ?>"><i class="fal fa-user" style="margin-top:30px;"></i><span><?php echo lang('login') ?></span></a>
                </div>
                ...
                <div class="nav-inner-wrap">
                    <nav class="nav-inner sound-nav" id="menu">
                        <ul>
                            ...
                            <li><a href="<?php echo base_url('Home/disc') ?>">disclaimer</a></li>
            ...
            <div id="wrapper">
                ...
                <div class="scroll-nav-wrap fl-wrap">
                    ...
                    <nav class="scroll-nav scroll-init">
                        <ul>
                            <li><a class="scroll-link act-link" href="#sec1"><?php echo lang('home') ?></a></li>
                            <li><a class="scroll-link" href="#sec5"><?= lang('our_project')?></a></li>
                            <li><a class="scroll-link" href="#sec2"><?php echo lang('invest') ?></a></li>
                            <li><a class="scroll-link" href="#sec7">FAQ</a></li>
                            <li><a class="scroll-link" href="#sec4"><?php echo lang('news') ?></a></li>
                            <li><a class="scroll-link" href="#sec6"><?php echo  lang('clients') ?></a></li>
                        </ul>
                    </nav>
                </div>
                <!-- scroll-nav-wrap end-->
                ...
                <div class="hero-wrap" id="sec1" data-scrollax-parent="true">
                    <!-- hero-inner-->
                    <div class="hero-inner fl-wrap full-height" style="margin-top: ">
                        <div class="half-hero-wrap">
                            <h1 style="margin-top:-50px;">R E I   <br>T R U S T<br> <span> <?php echo lang('inv_property') ?> </span></h1>
                                        <h4><?php echo $title_jumbotron ?></h4>
                            <div class="clearfix"></div>
                            <a href="<?php echo base_url('frontend/Signin') ?>" class="custom-scroll-link btn float-btn flat-btn color-btn mar-top intro_1"><?php echo lang('invest_with_us') ?></a>
                        ...
                        <div class="hero-decor-let">
                            <div><?php echo lang('recidence') ?></div>
                            <div><span><?php echo lang('comersial_center') ?></span></div>
                            <div><?php echo lang('hospital') ?></div>
                            <div><span><?php echo lang('eco_park') ?></span></div>
                        </div>
                        <div class="hero-decor-numb"><span>106.84513  </span><span>-6.21462 </span> <a href="https://goo.gl/maps/jWLNji39Xpv" target="_blank" class="hero-decor-numb-tooltip"><?php echo lang('ct_indonesia') ?></a></div>
                ...
                <div class="content">
                    ...
                    <section class="dark-bg" id="sec5">
                        <div class="fet_pr-carousel-title">
                            <div class="fet_pr-carousel-title-item">
                                <h3><?php echo lang('our_project') ?></h3>
                                <p style="font-size:10pt;">“<?php echo lang('inv_pers_read') ?>“    </p>
                                <a href="#" class="btn float-btn flat-btn color-btn mar-top"><?php echo lang('project_detail') ?></a>
                            </div>
                        </div>
                        ...
                        <div class="slider-carousel-wrap fl-wrap">
                            ...
                            <div class="fet_pr-carousel cur_carousel-slider-container fl-wrap">
                                ...
                                <?php foreach ($data_project_thumb->result() as $row ) { ;
                                    $gambar = base64_decode($row->file_foto);  ?>
                                <div class="slick-item">
                                    <div class="fet_pr-carousel-box">
                                        ...
                                        <div >
                                            <h3><a style="color: white;" href="<?php echo base_url()?>frontend/Prospektus/detail_prospektus/<?php echo $row->id_prospektus ?>"><?php echo $row->nama_unit ;?></a></h3>
                                            <div class="fet_pr-carousel-cat"><a href="#"></a> <a href="#"><?php echo $row->nama_kawasan ?></a></div><br>
                                           <p class="fet_pr-carousel-box-text fl-wrap" style="font-size: 10pt;color: white;"><?php echo $row->title ?><hr width="" style="border-color: #FAC921;"></p>


                                            <div style="text-align: right;"><p style="margin-bottom:-30px;font-size: 11pt;color:#FAC921;font-style: bold;">Investment Return <br> <?php echo $row->target_investor ?>%</p></div>
                                            <br>
                                        </div>
                                    </div>
                                </div>
                         ...
                         <div class="slider-carousel-wrap fl-wrap hidden-sm hidden-xs" style="margin-top:30px;">
                            <!--fet_pr-carousel -->
                            <div class="fet_pr-carousel cur_carousel-slider-container fl-wrap">
                                <!--slick-item -->
                                <?php foreach ($data_project_thumb_2->result() as $row ) { ;
                                    $gambar = base64_decode($row->file_foto);  ?>
                                <div class="slick-item">
                                    <div class="fet_pr-carousel-box">
                                        <div class="fet_pr-carousel-box-media fl-wrap">
                                        ...
                                        <div >
                                           ...
                                           <p class="fet_pr-carousel-box-text fl-wrap" style="font-size: 10pt;color: white;"><?php echo $row->title ?><hr width="" style="border-color: #FAC921;"></p>
                                            ...
                                            <div style="text-align: right;"><p style="margin-bottom:-30px;font-size: 11pt;color:#FAC921;font-style: bold;"><?php echo lang('investor_target') ?><br> <?php echo $row->target_investor ?>%</p></div>
                                            <br>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <section class="parallax-section dark-bg sec-half parallax-sec-half-right" data-scrollax-parent="true">
                        ...
                        <div class="container">
                            <div class="section-title">
                                <h2><?php echo lang('our_work') ?></h2>
                                <p> <?php echo lang('project_note') ?></p>
                            ...
                            <div class="fl-wrap facts-holder">
                                ...
                                <div class="inline-facts-wrap">
                                    <div class="inline-facts">
                                        ...
                                        <h6><?php echo lang('finish_project') ?></h6>
                                    </div>
                                </div>
                                <!-- inline-facts end -->
                                <!-- inline-facts  -->
                                <div class="inline-facts-wrap">
                                    <div class="inline-facts">
                                        ...
                                        <h6><?php echo lang('our_clients') ?></h6>
                                    </div>
                                </div>
                                <!-- inline-facts end -->
                                <!-- inline-facts  -->
                               <!--  <div class="inline-facts-wrap">
                                ...
                                <div class="inline-facts-wrap">
                                    <div class="inline-facts">
                                        ...
                                        <h6><?php echo lang('unit_property') ?></h6>
                                    </div>
                                </div>
                                <!-- inline-facts end -->                             
                            </div>
                   ...
                   <!--  <section class="dark-bg sinsec-dec sinsec-dec2">
                        <div class="container">
                            <div class="row">
                                ...
                                <h3><?php echo lang('video_present')?></h3> 
                                <?php echo $vid_narasi ?>
                                <a href="https://youtube/RvDTXApHCMM" class="btn float-btn flat-btn color-btn mar-top">My Youtube Chanel</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                   ...
                   <section>
                        ...
                        <div class="section-subtitle left-pos"  data-scrollax="properties: { translateY: '-250px' }" ><span>//</span>FAQ</div>
                    ...
                    <section class="parallax-section dark-bg sec-half parallax-sec-half-left" data-scrollax-parent="true" id="sec4">
                        ...
                        <div class="container">
                            <div class="section-title">
                               <h2><?php echo lang('news_title') ?></h2>
                               <?php echo $berita?>
                        ...
                        <div class="fl-wrap">
                            <div class="container">
                                <ul class="client-list client-list-white">
                                    ...
                                    <li><a href="#" target="_blank"><img src="<?= base_url() ?>assets_frontend/home/images/clients/2.png"style="margin-top:10px;" alt=""></a></li>
                    ...
                    <section class="dark-bg2 small-padding order-wrap">
                        <div class="container">
                            <div class="row">
                                <div class="col-md-8">
                                    <h3><?php echo lang('ready_invest') ?></h3>
                                </div>
                                <div class="col-md-4"><a href="<?php echo base_url('frontend/Signin') ?>" class="btn flat-btn color-btn"><?php echo lang('invest') ?></a> </div>
                            </div>
                        </div>
                    </section>
                    <!-- section end-->
