...
<nav class="hk-breadcrumb" aria-label="breadcrumb">
    <ol class="breadcrumb breadcrumb-light bg-transparent">
        <li class="breadcrumb-item"><a href="<?= base_url('prospektus') ?>">Tambah Detail</a></li>
...
<div class="hk-pg-header">
    <div class="col-md-6">
		<h2 class="hk-pg-title font-weight-600"><span class="pg-title-icon"><span class="feather-icon"><i data-feather="plus"></i></span></span>Tambah Judul Detail</h2>
	</div>
    <div class="col-md-6">
        <?php if ($detail != null): ?>
...
<!-- /Title -->
    ...
    <div class="collapse mt-10" id="daftar">
        <div class="card card-body">
            <form method="post" action="<?= base_url('prospektus/hapus_gambar_detail/kosong/'.$id_pros) ?>">
                <div class="row mb-20">
                    <div class="col-md-12">
        ...
        <div class="card card-body">
            <form method="POST" action="<?= base_url('prospektus/simpan_gambar_detail') ?>" enctype="multipart/form-data">
                ...
                <div class="col-md-8 text-center">
                    ...
                    <input type="hidden" name="id_det_pros" value="">
...
<div class="row">
    <div class="col-md-12">
        <div class="card">
            <form method="post" action="<?= base_url('prospektus/tambah_data_judul') ?>">
            <div class="card-body">
                <input type="hidden" name="id_pros" value="<?= $id_pros ?>">
                <label for="judul">Judul Detail</label>
                <select name="judul" id="judul" class="form-control">
                    <option value="">-- Pilih Judul --</option>
                    <?php foreach ($judul_1->result_array() as $j): ?>
