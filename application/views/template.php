...
<head>
    ...
    <title><?= nbs(3) ?><?= (!empty($judul) ? $judul.' |' : '') ?> R E I - T R U S T</title>
            ...
            <div class="nicescroll-bar">
                <div class="navbar-nav-wrap">
                    <ul class="navbar-nav flex-row">
                        ...
                        <li class="nav-item <?= ($aktif == 'prospektus') ? 'active' : '' ?>">
                            <?php if ($this->session->userdata('level') != 'kontributor'): ?>
                                    ...
                                    <?php if ($this->session->userdata('level') == 'koperasi'): ?>
                                        ...
                                        <?php if (!empty($this->session->userdata('kode_transaksi'))): ?>    
                                            <a class="nav-link" href="<?= base_url('prospektus/koperasi/blok/'.base64_encode($this->session->userdata('kode_transaksi'))) ?>" >
                                        <?php else : ?>
                                            <a class="nav-link" href="<?= base_url('prospektus/koperasi/blok') ?>" >
                                        <?php endif ?>
                                    <?php elseif ($this->session->userdata('level') == 'investor'): ?>
                                        <?php if (!empty($this->session->userdata('kode_transaksi'))): ?>    
                                            <a class="nav-link" href="<?= base_url('prospektus/index/blok/'.base64_encode($this->session->userdata('kode_transaksi'))) ?>" >
                                        <?php else : ?>
                                            <a class="nav-link" href="<?= base_url('prospektus/index/blok') ?>" >
                                        <?php endif ?>
                        ...
                        <?php if ($this->session->userdata('level') == 'koperasi' || $this->session->userdata('level') == 'investor'): ?>

                        <li class="nav-item <?= ($aktif == 'transaksi_kop') ? 'active' : '' ?>">
                            <a class="nav-link" href="<?= base_url('prospektus/transaksi_kop/'.base64_encode($this->session->userdata('kode_transaksi'))) ?>">
                                <i class="material-icons">add_shopping_cart</i><?= nbs(3) ?>
                        ...
                        <li class="nav-item <?= ($aktif == 'Anggota') ? 'active' : '' ?>">
                            <a class="nav-link" href="<?= base_url('prospektus/anggota_kop') ?>">
                                <i class="material-icons">perm_identity</i><?= nbs(3) ?>
                                    <span class="nav-link-text">Anggota</span>
                            </a>
                        </li>
                        <!-- history transaksi koperasi -->
                         <li class="nav-item <?= ($aktif == 'history_transaksi_kop') ? 'active' : '' ?>">
                            <a class="nav-link" href="<?= base_url('prospektus/history_kop') ?>">
                                <i class="material-icons">history</i><?= nbs(3) ?>
                                    <span class="nav-link-text">History Transaksi</span>
                            </a>
                        </li>
                       ...
                       <!-- <li class="nav-item <?= ($aktif == '' || $aktif == '') ? 'active' : '' ?>">
                        ...
                        <?php if ($this->session->userdata('level') == 'admin' || $this->session->userdata('level') == 'manager'): ?>
                            ...
                            <li class="nav-item <?= ($aktif == 'approve_lot') ? 'active' : '' ?>">
                                <a class="nav-link" href="<?= base_url('manager/approve_lot') ?>">
                            ...
                            <li class="nav-item <?= ($aktif == 'publish_report') ? 'active' : '' ?>">
                                <a class="nav-link link-with-badge" href="<?= base_url('manager/publish_report') ?>">
                        ...
                        <?php if ($this->session->userdata('level') == 'investor'): ?>
                            <!-- <li class="nav-item <?= ($aktif == 'saham_properti') ? 'active' : '' ?>">
                                <a class="nav-link link-with-badge" href="<?= base_url('investor/saham_properti') ?>">
                            ...
                            <li class="nav-item <?= ($aktif == 'histori_transaksi') ? 'active' : '' ?>">
                                <a class="nav-link link-with-badge" href="<?= base_url('investor/histori_transaksi') ?>">
                                    <i class="material-icons">history</i><?= nbs(3) ?>
