            ...
            <div class="row mt-10">
                ...
                <?php if ($aksi == 'tambah'): ?>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" id="no_telp" name="no_telp" class="form-control" placeholder="Masukkan No Telepon" required="">
                        </div>
                        <div class="form-group">
                            <label class="control-label" for="alamat">Alamat (Saat Ini)</label>
                            <textarea name="alamat" id="alamat" class="form-control" id="alamat" cols="5" rows="5" placeholder="Masukkan Alamat"></textarea>
                        </div>
                        <div class="form-group">
                ...
                <?php elseif ($aksi == 'edit'): ?>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            <label for="no_telp">No Telepon</label>
                            <input type="text" id="no_telp" name="no_telp" class="form-control" value="<?= $d_pengguna['no_telp'] ?>" required="">
                        </div>
                        <div class="form-group">
                            <label class="control-label" for="alamat">Alamat (Saat Ini)</label>
                ...
                <?php else: ?>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            <label for="no_telp">No Telepon</label>
                            <input type="text" id="no_telp" name="no_telp" class="form-control" value="<?= $d_pengguna['no_telp'] ?>" disabled>
                        </div>
                        <div class="form-group">
                            <label class="control-label" for="alamat">Alamat (Saat Ini)</label>
