...
<div class="hk-pg-header">
    <div class="col-md-6">
		<h2 class="hk-pg-title font-weight-600"><span class="pg-title-icon"><span class="feather-icon"><i data-feather="plus"></i></span></span>Tambah Data Resources</h2>
	</div>
    <div class="col-md-6">
...
<?= $this->session->flashdata('pesan'); ?>
    ...
    <div class="collapse mt-10" id="daftar">
        <div class="card card-body">
            <form method="post" action="<?= base_url('prospektus/hapus_gambar_detail/res/'.$id_pros) ?>">
                <div class="row mb-20">
                    <div class="col-md-12">
                        <?php if ($this->session->userdata('level') != 'kontributor'): ?>
                            <?php if (!empty($data_gambar)): ?>
        ...
        <div class="card card-body">
            <form method="POST" action="<?= base_url('prospektus/simpan_gambar_detail') ?>" enctype="multipart/form-data">
                ...
                <div class="col-md-8 text-center">
                    ...
                    <input type="hidden" name="id_det_pros" value="res">
...
<div class="card">
    <form method="post" action="<?= base_url('prospektus/simpan_res') ?>" enctype="multipart/form-data">
    <div class="card-body">
            <div class="row">
                <div class="col-md-12 form-group">
                    ...
                    <label for="lastName">Isi Resource</label>
                    <div class="tinymce-wrap">
                        <textarea class="tinymce form-control" name="isi_res"></textarea>
                    </div>
                </div>
            </div>
    </div>
