                            ...
                            <div class="row">
                                <div class="col-md-6 form-group">
                                    ...
                                    <div class="input-group">
                                        <input class="form-control" name="target" id="target" placeholder="<?php echo lang('i_target') ?>" type="text">
                                    ...
                                    <div class="form-group">
                                        <div class="input-group">
                                            ...
                                            <input class="form-control" id="harga" name="harga" placeholder="<?php echo lang('i_price') ?>" type="text" readonly>
                                        </div>
                                    </div>

                                    <br>
                                    <label for="jml"><?php echo lang('total_lot') ?></label>
                                    <input class="form-control" id="jml" name="jml_lot" placeholder="<?php echo lang('i_total_lot') ?>" type="text"><span id="errmsg"></span><br>
                                    ...
                                    <div class="form-group">
                                        <div class="input-group">
                                            ...
                                            <input class="form-control" id="invest" name="invest_min" placeholder="<?php echo lang('i_min_invest') ?>" type="" readonly>
                                        </div>
                                    </div>
                                    <br>
                                ...
                                <div class="col-md-6 form-group">
                                    ...
                                    <div class="form-group">
                                        <div class="input-group">
                                            <input class="form-control" name="periode" id="periode" placeholder="Masukkan Periode Investasi" type="number">
                                            <div class="input-group-append">
...
<script>
    ...
    $(document).ready(function(e) {
        ...
        $("input").keyup( function() {
          ...
          if (!isNaN(tot_nilai)) 
                {
                    $("input[id=invest]").val(formatNumber(Math.round(tot_nilai)));
                }
