...
<body>
    ...
    <div class="hk-wrapper hk-vertical-nav">
        ...
        <div class="hk-settings-panel">
            <div class="nicescroll-bar position-relative">
                <div class="settings-panel-wrap">
                    <div class="settings-panel-head">
                        <img class="brand-img d-inline-block align-top" src="<?= base_url() ?>assets/dist/img/logo-light.png" alt="brand" />
                    ...
                    <div class="layout-img-wrap">
                        <div class="row">
                            <a href="javascript:void(0);" class="col-6 mb-30 active">
                                <img class="rounded opacity-70" src="<?= base_url() ?>assets/dist/img/layout1.png" alt="layout">
                                <i class="zmdi zmdi-check"></i>
                            </a>
                            <a href="dashboard2.html" class="col-6 mb-30">
                                <img class="rounded opacity-70" src="<?= base_url() ?>assets/dist/img/layout2.png" alt="layout">
                                <i class="zmdi zmdi-check"></i>
                            </a>
                           <a href="dashboard3.html" class="col-6 mb-30">
                                <img class="rounded opacity-70" src="<?= base_url() ?>assets/dist/img/layout3.png" alt="layout">
                                <i class="zmdi zmdi-check"></i>
                            </a>
							<a href="dashboard4.html" class="col-6 mb-30">
                                <img class="rounded opacity-70" src="<?= base_url() ?>assets/dist/img/layout4.png" alt="layout">
                                <i class="zmdi zmdi-check"></i>
                            </a>
							<a href="dashboard5.html" class="col-6">
                                <img class="rounded opacity-70" src="<?= base_url() ?>assets/dist/img/layout5.png" alt="layout">
                                <i class="zmdi zmdi-check"></i>
                            </a>
                        </div>
                    </div>
            ...
            <img class="d-none" src="<?= base_url() ?>assets/dist/img/logo-light.png" alt="brand" />
            <img class="d-none" src="<?= base_url() ?>assets/dist/img/logo-dark.png" alt="brand" />
        </div>
        <!-- /Setting Panel -->
    ...
    <script src="<?= base_url() ?>assets/dist/js/toast-data.js"></script>
