                ...
                if ($c['aktif'] == 1) {
                    ...
                    if($c['level'] == "3" AND $this->session->userdata('id_prospektus') != NULL){
                      ...
                      $array = array(
                         ...
                         redirect('prospektus/index/blok/');
                      ...
                      $array = array(
                       ...
                       redirect('Prospektus/koperasi/blok/');
   ...
   array('matches' => 'Password confirmation does not match'));
    ...
    else
    {
      ...
      $config = array(
          ...
          'smtp_port' => 465,
          'smtp_user' => 'inibaruafif@gmail.com', // change it to yours
          'smtp_pass' => "baru4f11f", // change it to yours
          'mailtype' => 'html',
          'charset' => 'iso-8859-1',
          'wordwrap' => TRUE
      );
      ...
      $message =  "
        ...
        if($this->email->send()){
          $this->session->set_flashdata('message','<div class="alert alert-inv alert-inv-danger alert-wth-icon alert-dismissible fade show" role="alert">
                <span class="alert-icon-wrap"><i class="fa fa-key" style="margin-top: -10px"></i></span> Activation code sent to email
                <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                    <span aria-hidden="true">×</span>
                </button>
            </div>
