...
class Home_en extends CI_Controller {
	...
	{	
		...
		$this->load->view('front_end/V_home_en',$data);
	}
	...
	{	$this->load->library('Cek_login_lib');
		...
		$this->template->load('template','front_end/V_home_edit_en',$data);
	}
