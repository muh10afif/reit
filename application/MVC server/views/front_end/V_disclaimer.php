...
<body>
    <div class="page sub-page">
        ...
        <!--*********************************************************************************************************-->
        <header class="hero" >
            <div class="hero-wrapper" style="padding-bottom: 20px;">
                ...
                <nav class="navbar navbar-expand-sm navbar-dark bg-dark ">
                    ...
                    <div id="my-nav" class="collapse navbar-collapse">
                        <ul class="navbar-nav ml-auto">
                            ...
                            <li class="nav-item active ">
                                <a class="nav-link" href="<?php echo base_url() ?>/frontend/Signin/register"><i class="fa fa-pencil-square-o"></i> <?php echo lang('register') ?> <span class="sr-only">(current)</span></a>
                            </li>
                            <li class="nav-item active" <?php if($this->session->userdata('masuk') != TRUE){echo "hidden";} ?>>
    ...
    <section class="block">
		<div class="container">
			<!-- <div class="page-header">
			  <h1><i class="fa fa-file-text"></i> Disclaimer</h1>
			</div> -->
			<div class="container card" style="width:70%">
					<div class="card-body">
						<div class="container" style="width:90%;">
						<p style="font-size: 14pt;color:black;text-align: center;"><?php echo lang('term_condition') ?></p>
