			...
			<div class="card-body">
				<nav>
				  <div class="nav nav-tabs" id="nav-tab" role="tablist">
				    <a class="nav-item nav-link active" id="nav-home-tab" data-toggle="tab" href="#nav-prospektus" role="tab" aria-controls="nav-home" aria-selected="true">Transaksi Jual</a>
				    <a class="nav-item nav-link" id="nav-profile-tab" data-toggle="tab" href="#nav-unit" role="tab" aria-controls="nav-profile" aria-selected="false">Transaksi Beli</a>
				  </div>
				</nav>
