...
<div class="hk-pg-header mt-10">
    ...
    <div class="col-md-6">
        <?php if ($this->session->userdata('level') == 'admin' || $this->session->userdata('level') == 'manager' || $this->session->userdata('level') == 'copywriter'): ?>
            <button class="btn btn-icon btn-icon-style-1 btn-green mt-10 float-right btn-lg shadow-xl" style="width: 140px;" onclick="tambah_blok()"><i class="ti-plus"></i><?= nbs(2) ?><?php echo lang('add'); ?></button>
        <?php endif ?>
    </div>
                ...
                <?php endif ?>
                    ...
                    <div class="card-footer" style="margin-top: -14px">
                        ...
                        <?php else: ?>
                            ...
                            <?= nbs(3) ?>
                            <button type="button" class="btn btn-sm btn-icon btn-indigo btn-icon-style-1" style="width: 100px;" onclick="edit_blok('<?= $d['id_blok'] ?>')"><i class="ti-pencil-alt"></i><?= nbs(2) ?>EDIT</button>
                        <?php endif ?>
